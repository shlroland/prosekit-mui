...
describe('static renderer', () => {
  it('renders rich text content to React markup', () => {
    ...
    expect(markup).toContain('data-static-link-favicon="true"')
    expect(markup).toContain('data="https://example.com/favicon.ico"')
    expect(markup).toContain('data="https://example.org/favicon.ico"')
    expect(markup).toContain('data-static-link-favicon-fallback="true"')
  ...
  it('renders rich text content to an HTML string', () => {
    ...
    expect(html).toContain('data-static-link-favicon="true"')
    expect(html).toContain('data="https://example.com/favicon.ico"')
    expect(html).toContain('data="https://example.org/favicon.ico"')
    expect(html).toContain('data-static-link-favicon-fallback="true"')
