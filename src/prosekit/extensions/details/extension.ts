...
import { defineDetailsCommands, setDetails, unsetDetails } from './commands'
import { defineDetailsNodeView } from './node-view'
import { defineDetailsSpec } from './spec'
import type { DetailsExtension } from './types'
...
function defineDetailsKeymap(): PlainExtension {
...
export function defineDetailsExtension(): DetailsExtension {
  return union(
    defineDetailsSpec(),
